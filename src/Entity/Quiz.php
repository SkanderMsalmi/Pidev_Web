 ...
 * Quiz
 *
 * @ORM\Table(name="quiz", indexes={@ORM\Index(name="fk_question5", columns={"idQuestion5"}), @ORM\Index(name="fk_question2", columns={"idQuestion2"}), @ORM\Index(name="fk_question3", columns={"idQuestion3"}), @ORM\Index(name="fk_question4", columns={"idQuestion4"}), @ORM\Index(name="fk_question1", columns={"idQuestion1"})})
 * @ORM\Entity
 */
class Quiz
{
