...
class QuizController extends AbstractController
{
     ...
     */
    public function passerQuiz(FlashyNotifier $flashy): Response
    {
        ...
        $score = 0;
        //dd($quiz);
        $this->addFlash("success","La quiz commence !! Bon Courage.");
     ...
     */
    public function show($idquiz): Response
    {
     ...
     */
    public function delete(Request $request, $idquiz, EntityManagerInterface $entityManager): Response
    {
        $qr = $this->getDoctrine()->getRepository(Quiz::class);
        $quiz = $qr->find($idquiz);
