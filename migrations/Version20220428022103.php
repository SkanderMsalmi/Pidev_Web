 ...
 */
final class Version20220428022103 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation CHANGE nom nom VARCHAR(30) DEFAULT NULL, CHANGE dateReservation dateReservation DATE DEFAULT NULL, CHANGE idFormation idFormation INT DEFAULT NULL');
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C84955FE6E88D7 FOREIGN KEY (idUser) REFERENCES user (id)');
        $this->addSql('CREATE INDEX fk_personneReservation ON reservation (idUser)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX fk_personneReservation ON reservation');
