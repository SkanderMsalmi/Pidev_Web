 ...
 */
final class Version20220428002132 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C84955BCAA0AE9 FOREIGN KEY (idFormation) REFERENCES formation (idFormation)');
