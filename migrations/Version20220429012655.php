 ...
 */
final class Version20220429012655 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE formation DROP FOREIGN KEY FK_404021BF5C6DE3B4');
        $this->addSql('ALTER TABLE formation CHANGE description description VARCHAR(1000) NOT NULL, CHANGE titre titre VARCHAR(255) NOT NULL, CHANGE type type VARCHAR(255) NOT NULL, CHANGE domaine domaine VARCHAR(255) NOT NULL');
        $this->addSql('DROP INDEX idUser ON reservation');
        $this->addSql('ALTER TABLE reservation CHANGE nom nom VARCHAR(1000) NOT NULL, CHANGE dateReservation dateReservation DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C849553E5B884A FOREIGN KEY (idformation) REFERENCES formation (idformation)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE formation CHANGE description description VARCHAR(30) NOT NULL, CHANGE titre titre VARCHAR(30) NOT NULL, CHANGE type type VARCHAR(30) NOT NULL, CHANGE domaine domaine VARCHAR(30) NOT NULL');
        $this->addSql('ALTER TABLE reservation DROP FOREIGN KEY FK_42C849553E5B884A');
        $this->addSql('ALTER TABLE reservation DROP FOREIGN KEY FK_42C84955FE6E88D7');
        $this->addSql('DROP INDEX idUser ON reservation');
        $this->addSql('ALTER TABLE reservation CHANGE nom nom VARCHAR(30) NOT NULL, CHANGE dateReservation dateReservation DATE NOT NULL');
        $this->addSql('CREATE UNIQUE INDEX idUser ON reservation (idUser)');
